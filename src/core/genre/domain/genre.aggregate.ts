...
// //categoria - não search personalizado
// //cast member - tem search personalizado
// //genre - não search personalizado
//   //get genre
//   //list all genres - 2 consulta {name, categories: [id, name, description]}
//     // 1 - pegar os generos
//     // 2 - pegar as categorias

//     //outra decisão - criar modelo de leitura

//decisão separando o modelo de leitura do agregado
...
//   constructor(props: { genre_id: string; name: string }) {
//     this.genre_id = props.genre_id;
//     this.name = props.name;
//     this.categories = [];
//   }
...
// class GenreQuery{ //tablegateway

//   findAll(): Promise<GenreReadModel[]>{
//     //1 chamada para o elasticsearch
//   }
// }
